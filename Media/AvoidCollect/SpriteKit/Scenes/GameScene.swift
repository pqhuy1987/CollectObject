...
class GameScene: SKScene {
    ...
    let hudColor = UIColor.red
    let backColor = UIColor(red: 80/255, green: 30/255, blue: 90/255, alpha: 1)
    let circleColor = UIColor(red: 100/255, green: 120/255, blue: 50/255, alpha: 1)
    let squareColor = UIColor(red: 220/255, green: 200/255, blue: 100/255, alpha: 1)
